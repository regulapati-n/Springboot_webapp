...
public class HealthController {
    ...
    @RequestMapping(value = "/healthz", method = {RequestMethod.HEAD, RequestMethod.OPTIONS})
    public ResponseEntity<String> headAndOptionsHealth() { return getMethodNotAllowedResponse();}
